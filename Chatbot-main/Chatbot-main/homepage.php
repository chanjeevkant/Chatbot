...
<html lang="en">
   <head>
	...
	<br>
      ...
      <title>StudentInfo Chatbot</title>
  ...
  background-size: 100% 100%;
   ...
   <body>
               ...
               <div class="card">
                  ...
                  <div class="card-header">
                    <div class="input-group">
					   <input id="input-me" type="text"  autoComplete="off" name="messages" class="form-control input-sm" placeholder="Type your message here..." />

					   <span class="input-group-append">
					   <input type="submit" class="btn btn-primary" id="send_btn" value="Send" onclick="send_msg()">
					   </span>
					</div> 
                  </div>
               </div>
      ...
      <script type="text/javascript">
		  var send = document.getElementById("input-me");
		  send.addEventListener("keyup",function(event){if(event.keyCode===13){document.getElementById("send_btn").click();}})
